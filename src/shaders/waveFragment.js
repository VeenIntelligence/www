// 波浪画布片段着色器主体
// 注意：此字符串前面需要由 waveShaderBuilder 拼接 tier-specific #define
...
#define WOBBLE_POINTER 0.2   // 指针挥动对颤动的影响权重
...
// --- spike 在液面上的形变 ---
#define SPIKE_DEFORM 0.22   // spike 靠近时液面凹陷深度
#define SPIKE_DEFORM_FALL 0.8 // 凹陷衰减
#define WAKE_FREQ    1.0   // spike 尾迹波纹频率
#define WAKE_AMP     0.0    // spike 尾迹波纹振幅
